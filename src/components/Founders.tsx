      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Graduates from world's top universities with proven track records in admissions success
          </p>
        </div>
            ...
            <CardContent className="p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Economics graduate from London School of Economics with expertise in quantitative analysis and strategic thinking. Specializes in helping students craft compelling narratives for top-tier programs.
                </p>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 border-0 shadow-lg overflow-hidden">
            <CardContent className="p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Computer Science graduate from UC Berkeley with extensive experience in tech industry placements. Focuses on STEM applications and extracurricular development strategies.
                </p>
                <div className="mt-6 flex flex-wrap justify-center gap-2">
